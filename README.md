...
**Patchworklib has been updated to allow arranging multiple plots generated by plotnine.**

```python
import patchworklib as pw
from plotnine import *
from plotnine.data import *
g1 = pw.load_ggplot(ggplot(mtcars) + geom_point(aes("mpg", "disp")) + theme(figure_size=(4, 6)))
g2 = pw.load_ggplot(ggplot(mtcars) + geom_boxplot(aes("gear", "disp", group = "gear")) + theme(figure_size=(4, 6)))
g12 = g1 | g2
g12.savefig()
```

 <img src="img/patchwork_plotine.png" width="600x600">
